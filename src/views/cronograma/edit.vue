...
export default {
    ...
    methods: {
        ...
        async getData(){
            ...
            const resp = await TravelService.getTravelById(this.$route.params.id, this.$store)
        ...
        async saveData(){
            ...
            resp = await TravelService.updateTravel(this.$route.params.id, this.dataItems, this.$store)
            console.log('resp', resp)
            if (resp.status) {
                this.$swal({
                title: 'Actualizado',
        ...
        async validGeneral() {
            ...
            return new Promise((resolve, reject) => {
                ...
                if (success) {
                    ...
                    const resp = await TravelService.getTemplateTravel(data, this.$store)
