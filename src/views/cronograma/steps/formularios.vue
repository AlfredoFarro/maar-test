<template>
    <div class="w-100">
        ...
        <validation-observer #default="{ invalid }" ref="refFormObserver">
            <b-card no-body style="padding-left: 0;">
                <!-- DESPACHO -->
                <b-row class="mb-2">
                ...
                <b-table :class="{'table-responsive': rowsDespacho.length > 0}" :items="rowsDespacho" :fields="fields">
                    ...
                    <template v-slot:cell(isDoublePhoto)="row">
                        <validation-provider #default="{ errors }" rules="" style="display: flex; align-items: center; justify-content: center;">
                            <b-form-checkbox
                    ...
                    <template v-slot:cell(isPersonal)="row">
                        <validation-provider v-if="!row.item.user" #default="{ errors }" rules="" style="display: flex; align-items: center; justify-content: center;">
                            <b-form-checkbox
                        ...
                        <p v-else style="font-weight: bold;">{{ row.item.user.fullname }}</p>
...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: 'order', label: 'Orden', sortable: false },
    ...
    methods: {
        ...
        addDespacho(){
            this.rowsDespacho.push({ formId: null, isDoublePhoto: false, isPersonal: false, mandatory: false, repeatable: 0, groupLvl1Id: null, groupLvl2Id: null })
        ...
        addEmbarque(){
            this.rowsEmbarque.push({ formId: null, isDoublePhoto: false, isPersonal: false, mandatory: false, repeatable: 0, groupLvl1Id: null, groupLvl2Id: null })
        ...
        addConduccion(){
            this.rowsConduccion.push({ formId: null, isDoublePhoto: false, isPersonal: false, mandatory: false, repeatable: 0, groupLvl1Id: null, groupLvl2Id: null })
        ...
        addFinalizacion(){
            this.rowsFinalizacion.push({ formId: null, isDoublePhoto: false, isPersonal: false, mandatory: false, repeatable: 0, groupLvl1Id: null, groupLvl2Id: null })
            console.log("ROWS Finalizacioan",this.rowsFinalizacion)
        },
        ...
        async editAddedRow(item, index, input="SELECT input type"){
            ...
            if(item.id){
                //recorrer array editedRows, y eliminar el item que tenga el mismo item.id
                this.editedRows = this.editedRows.filter((element) => {
        ...
        async getGroupsCodes(){
            ...
            console.log("ARRAY FILTERSSSSSS",arrayFilters)
            const url =
            `?limit=10000&filter=` +
            JSON.stringify(arrayFilters)
