      ...
      <b-card ref="filterContent" no-body class="sticky">
        <b-card-body>
          <b-row>
            ...
            <b-col lg="3" class="col-xxl">
              <b-form-group label="Servicio" label-for="type" class="mr-2">
                <v-select
                  :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
                  :options="tipos"
                  input-id="type"
  ...
  methods: {
    async exportCrono(id){
      if (id != null) {
          ...
          fileLink.href = this.apiurl + '/travel/download/' + id + url
    ...
    async exportHeaderCrono(id){
      if (id != null) {
          ...
          // console.log('resp',resp)
          var fileLink = document.createElement('a')
          fileLink.href = this.apiurl + '/travel/header/download/' + id + url
          console.log('fileLink.href', fileLink.href)
          fileLink.setAttribute('target', '_blank')
          document.body.appendChild(fileLink)
          fileLink.click()
    ...
    async reactivateData(id) {
      ...
      const resp = await TravelService.reactivateTravel(id, this.$store)
 ...
 */      
    ...
    async getAllData() {
      ...
      const url =
        ...
        console.log("HOLA")
      console.log('URL', url)
      const resp = await TravelService.getTravels(url, this.$store)
