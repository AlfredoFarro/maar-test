                    ...
                    <template v-slot:cell(formId)="row">
                        <validation-provider #default="{ errors }" rules="requeridoE">
                            <v-select
                                ...
                                @input="editAddedRow(row.item, row.index, 'formulario')"
                                class="select-obra">
                            </v-select>
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    ...
                    <template v-slot:cell(repeatable)="row">
                        <validation-provider #default="{ errors }" rules="requeridoE" style="display: flex; align-items: center; justify-content: center;">
                            <b-form-checkbox
                                ...
                                @change="editAddedRow(row.item, row.index, 'repetible')"
                            ></b-form-checkbox>
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </template>
...
export default {
    ...
    methods: {
        ...
        deleteDespacho(index){
            ...
            console.log("ROW ELIMINADA TEMP",index,this.rowsDespacho[index])
