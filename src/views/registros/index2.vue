  ...
  methods: {
    ...
    async reactivate(index){
      ...
      this.$swal({
        ...
        if (result.isConfirmed) {
          const resp = await TravelService.reactivateForm(index.id, this.$store)
    ...
    async getAllData() {
      ...
      const url =
        ...
        JSON.stringify(this.arrayFilters)
      console.log("url,", url)
      const resp = await TravelService.getRecordsById(this.$route.params.id, this.$store)
    ...
    downloadForm(){
      if (this.idRow != null) {
        ...
        fileLink.href =
          this.apiurl + "/record-form/downloadDeclaration/" + this.idRow;
