    ...
    async handleSubmit() {
      try {
        ...
        const response = this.isEdit 
          ? await DisciplineService.updateDiscipline(this.discipline.id, { name: this.discipline.name }, this.$store)
          : await DisciplineService.saveDiscipline({ name: this.discipline.name }, this.$store);
