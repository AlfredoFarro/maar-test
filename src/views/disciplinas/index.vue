    ...
    methods: {
      async changeStatus1(item) {
        ...
        try {
          ...
          const resp = await DisciplineService.updateDiscipline(item.id, updateData, this.$store);
      ...
      async deleteData(id) {
        ...
        const resp = await DisciplineService.deleteDiscipline(id, this.$store)
      ...
      async getAllData() {
        ...
        const url =
          ...
          JSON.stringify(this.arrayFilters)
          console.log("HOLA")
        const resp = await DisciplineService.getDiscipline(url, this.$store);
